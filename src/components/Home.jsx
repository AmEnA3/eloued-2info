	...
	return (
		<main className="container-page center-section">
			<m.div
				...
				className="mb-8"
			>
				<h1 className="text-3xl md:text-4xl font-bold mb-2 drop-shadow">Welcome to the 2nd year of computer science</h1>
				<p className="text-slate-300 max-w-xl mx-auto">Plateforme moderne pour partager les ressources et les annonces en temps réel.</p>
			</m.div>
